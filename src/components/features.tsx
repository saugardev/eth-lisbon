              ...
              <div className="relative flex flex-col text-center lg:text-right">
                ...
                >
                  <div className="relative inline-flex flex-col">
                    ...
                    <Image className="md:max-w-none absolute w-full left-0 transform animate-float" src="/images/features-element.png" width={500} height="44" alt="Element" style={{ top: '30%' }} />
                  </div>
                </Transition>
                {/* Item 2 */}
                <Transition
